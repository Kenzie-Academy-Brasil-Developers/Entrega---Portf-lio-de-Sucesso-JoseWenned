...
import { RegisterEvaluationPage } from "../Pages/RegisterEvaluation/registerEvaluation.page"
    ...
    return(
        <>
            <Routes>
                ...
                <Route path="/RegisterEvaluationPage" element={<RegisterEvaluationPage/>}></Route>
            </Routes>
        </>
    )
}